...
export default function PrivacyPage() {
  const jsonLd = {
    ...
    "@type": "WebPage",
    name: "Junhae Studio Privacy Policy",
    description:
      "Information on data collection and user rights at Junhae Studio.",
    publisher: {
      "@type": "Organization",
      name: "Junhae Studio",
        ...
        <div className="space-y-16 leading-relaxed">
          ...
          <section>
            <p className="text-xl text-stone-600 font-light max-w-2xl leading-relaxed">
              ...
              values your privacy. We are committed to being transparent about
              how we collect, use, and protect your information as you shop for
              our
          ...
          <section className="grid md:grid-cols-3 gap-8 border-t border-stone-100 pt-10">
            ...
            <div className="md:col-span-2 text-stone-600 font-light">
              <p>
                Your data is used strictly for operational excellence:
                fulfilling orders, providing tailored customer support, and
                maintaining the security of our storefront against fraudulent
                activity. We prioritize the safety of our global{" "}
